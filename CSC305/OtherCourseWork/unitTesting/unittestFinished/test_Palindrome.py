...
class PalindromeTestCase(unittest.TestCase):
    ...
    def test_None_raises_ValueError(self):
        self.assertRaises(ValueError, self._palindrome.is_palindrome, None)
        
    def test_all_non_alphanumeric_raises_ValueError(self):
        self.assertRaises(ValueError, self._palindrome.is_palindrome, "|^~^|")

    def test_all_numeric_string_is_palindrome(self):
        self.assertTrue(self._palindrome.is_palindrome("10000.1"))

    def test_all_numeric_string_not_palindrome(self):
        self.assertFalse(self._palindrome.is_palindrome("10000.0"))

    def test_unicode_string_is_palindrome(self):
        self.assertTrue(self._palindrome.is_palindrome("ÂÊpêâ"))

    def test_unicode_string_not_palindrome(self):
        self.assertFalse(self._palindrome.is_palindrome("ÂÊÂÊ"))
